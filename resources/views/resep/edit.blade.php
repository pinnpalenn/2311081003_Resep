    ...
    <div class="card-body">
        <form action="{{ route('resep.update', $resep->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('judul_resep') is-invalid @enderror" id="judul_resep" name="judul_resep" value="{{ old('judul_resep', $resep->judul_resep) }}" required>
                @error('judul_resep')
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('kategori') is-invalid @enderror" id="kategori" name="kategori" required>
                    ...
                    <option value="Makanan Utama" {{ old('kategori', $resep->kategori) == 'Makanan Utama' ? 'selected' : '' }}>Makanan Utama</option>
                    <option value="Dessert" {{ old('kategori', $resep->kategori) == 'Dessert' ? 'selected' : '' }}>Dessert</option>
                    <option value="Sarapan" {{ old('kategori', $resep->kategori) == 'Sarapan' ? 'selected' : '' }}>Sarapan</option>
                    <option value="Makanan Ringan" {{ old('kategori', $resep->kategori) == 'Makanan Ringan' ? 'selected' : '' }}>Makanan Ringan</option>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('bahan') is-invalid @enderror" id="bahan" name="bahan" rows="5" required>{{ old('bahan', $resep->bahan) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('langkah_pembuatan') is-invalid @enderror" id="langkah_pembuatan" name="langkah_pembuatan" rows="8" required>{{ old('langkah_pembuatan', $resep->langkah_pembuatan) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('waktu_memasak') is-invalid @enderror" id="waktu_memasak" name="waktu_memasak" value="{{ old('waktu_memasak', $resep->waktu_memasak) }}" min="1" required>
                @error('waktu_memasak')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('penulis') is-invalid @enderror" id="penulis" name="penulis" value="{{ old('penulis', $resep->penulis) }}" required>
                @error('penulis')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
